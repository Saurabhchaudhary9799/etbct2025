  ...
  return (
    ...
    <span className="relative text-white"> ETBCT </span>
          ...
          <div className='flex flex-col md:flex-row gap-y-5 md:gap-x-5'>
             <motion.div initial={{x:-200}} whileInView={{x:0}} viewport={{once:true}} className='w-full md:w-3/6 flex justify-center items-center'>
              <img className='' src={smvduLogo} alt="" />
             </motion.div>
             <motion.div initial={{x:200}} whileInView={{x:0}} viewport={{once:true}} className='w-full md:w-3/6 flex flex-col gap-y-2  justify-center'>
