...
<<<<<<< HEAD
        <motion.div whileHover={{scale:1.1}} className="border rounded-xl w-[300px] h-[350px]">
          ...
          <div className="pb-5">
             <h1 className="text-xl text-orange-500 text-center">Dr. Rakesh Kumar</h1>
        ...
        <motion.div whileHover={{scale:1.1}} className="border rounded-xl w-[300px] h-[350px]">
          ...
          <div className="pb-5">
             <h1 className="text-xl text-orange-500 text-center">Dr. Raju Shankarayan</h1>
             {/* <p className="text-lg text-center">Assistant Professor, SoBT</p> */}
             <p className="text-lg text-center">Workshop Co-Coordinator</p>
          </div>
        </motion.div>
        <motion.div whileHover={{scale:1.1}} className="border rounded-xl w-[300px] h-[350px]">
          ...
          <div className="pb-5">
             <h1 className="text-xl text-orange-500 text-center">Dr. Preeti Sharma</h1>
             {/* <p className="text-lg text-center">Assistant Professor, SoBT</p> */}
             <p className="text-lg text-center">Workshop Co-Coordinator</p>
          </div>
        </motion.div>
